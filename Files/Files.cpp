...
/*1)считать с файла всё цифры, посчитать количество круглых чисел
2)считать файл с словами, заменить все 'h' на 'k'
3)считать файл со словами, если после 'n' стоит 'a' то заменить 'a' на "hiiii"
